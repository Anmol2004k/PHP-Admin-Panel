...
<main class="dashboard-main">
  ...
  <ul class="d-flex align-items-center gap-2">
    ...
    <tr>
        <td>
            <div class="form-check style-check d-flex align-items-center">
                <input class="form-check-input" type="checkbox">
                <label class="form-check-label">
                    <?php echo str_pad($sl++, 2, "0", STR_PAD_LEFT); ?>
                </label>
            </div>
        </td>
        
        <td><a href="#" class="text-primary-600">#<?php echo $row['invoice_no']; ?></a></td>
        
        <td>
            <div class="d-flex align-items-center">
                <img src="assets/images/user-list/user-list1.png" alt="" class="flex-shrink-0 me-12 radius-8 w-32-px h-32-px">
                <h6 class="text-md mb-0 fw-medium flex-grow-1"><?php echo $row['customer_name']; ?></h6>
            </div>
        </td>
        ...
        <td>
            <?php 
                $status = $row['status'];
                // Status ke hisaab se color class select karna
                $class = ($status == 'Paid') ? 'success' : (($status == 'Pending') ? 'warning' : 'danger');
            ?>
            <span class="bg-<?php echo $class; ?>-focus text-<?php echo $class; ?>-main px-24 py-4 rounded-pill fw-medium text-sm">
                <?php echo $status; ?>
            </span>
        </td>
        ...
        <td>
            <div class="d-flex align-items-center gap-10">
                <a href="view-details.php?id=<?php echo $row['id']; ?>" class="w-32-px h-32-px bg-primary-light text-primary-600 rounded-circle d-inline-flex align-items-center justify-content-center">
    ...
    <?php 
        ...
        echo "<tr><td colspan='7' class='text-center'>Database mein koi data nahi mila!</td></tr>";
    }
    ?>
</tbody>
