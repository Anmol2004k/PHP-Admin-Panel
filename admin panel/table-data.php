...
<main class="dashboard-main">
  ...
  <ul class="d-flex align-items-center gap-2">
    ...
    // Agar database khali na ho toh loop chalayein
    ...
    <tr>
        ...
        <td>
            <div class="d-flex align-items-center">
                <img src="assets/images/user-grid/user-grid-img14.png" alt="" class="w-40-px h-40-px rounded-circle flex-shrink-0 me-12">
                <h6 class="text-md mb-0 fw-medium"><?php echo $row['customer_name']; ?></h6>
            </div>
        </td>
        ...
        <td>
            ...
            ?>
            <span class="badge bg-<?php echo $class; ?>-focus text-<?php echo $class; ?>-600 px-20 py-4 fw-semibold text-sm">
                <?php echo $status; ?>
            </span>
        </td>
        ...
        <td>
            <div class="d-flex align-items-center gap-10">
                <button class="text-success-600"><iconify-icon icon="lucide:edit"></iconify-icon></button>
                <button class="text-danger-600"><iconify-icon icon="lucide:trash"></iconify-icon></button>
            </div>
        </td>
    </tr>
    <?php 
        ...
        echo "<tr><td colspan='7' class='text-center'>No data found in database!</td></tr>";
    }
    ?>
</tbody>
            <tr>
